            ...
            <form action="{{ route('jurusan.update',$jurusan['id']) }}" method="POST">
              ...
              <div class="card-body">
                <div class="row form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="jurusan_kode" id="jurusan_kode" class="form-control" value="{{ $jurusan['jurusan_kode'] }}">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="jurusan_nama" id="jurusan_nama" class="form-control" value="{{ $jurusan['jurusan_nama'] }}">
                  </div>
                </div>
              </div>
